...
// Simulated session check - replace with your actual authentication
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-tabs">
                ...
                <li><a href="customer_dashboard.php" class="active">Drugs</a></li>
                <li><a href="customer_pharmacies.php">Pharmacies</a></li>
                <li><a href="customer_orders.php">Refills</a></li>
                <li><a href="customer_appointment.php">Appointments</a></li>
                <li><a href="customer_support.php">Support</a></li>
            </ul>

            <div class="nav-user">
                <div class="user-icon" title="<?php echo htmlspecialchars($_SESSION['user_name']); ?>">
    ...
    <div class="layout">
            ...
            <div class="bottom-widgets">
                    ...
                    <div class="pharmacy-map">
                        <div class="map-placeholder">
                            <svg class="map-grid" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M-10 50 L150 150 M50 -10 L150 200 M20 180 L200 40" stroke="rgba(255,255,255,0.5)" stroke-width="3" fill="none"/>
                            </svg>
                ...
                <div class="insight-card">
                    ...
                    <p class="insight-text">
                        Consistency is key. Your Lisinopril works best when taken at the same time every day. Try setting an alarm for 8:00 AM.
                    </p>
        ...
        <div class="footer-copy">
            &copy; 2024 PharmaDirect Basud. Your Digital Sanctuary for Health.
        </div>
    </footer>
