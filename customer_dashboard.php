...
<head>
    ...
    <title>Customer Dashboard - PharmaSync</title>
...
<body>
    ...
    <main class="container animate-fade" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;">
        <div class="card" style="max-width: 500px; width: 100%;">
            <h1 style="font-size: 1.75rem; font-weight: 700; color: var(--primary); margin-bottom: 1rem;">Customer Portal Logged In</h1>
            <p style="color: var(--text-muted); margin-bottom: 2rem;">Welcome, Basud Resident! Login button workflow successfully verified.</p>
